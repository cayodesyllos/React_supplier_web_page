...
import { updateRejectFornecedores} from './fornecedores';
import { updateRevertRejectionFornecedores} from './fornecedores';
...
import { getRejectedFornecedores} from './fornecedores';
...
export default function* rootSaga() {
    ...
    yield all([
        ...
        takeLatest(FornecedoresTypes.UPDATE_REJECTION_REQUEST, updateRejectFornecedores),
        takeLatest(FornecedoresTypes.UPDATE_REVERT_REJECTION_REQUEST, updateRevertRejectionFornecedores),
        ...
        takeLatest(FornecedoresTypes.GET_REJECTED_REQUEST, getRejectedFornecedores),
